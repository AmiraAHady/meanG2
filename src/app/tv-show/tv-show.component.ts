...
export class TvShowComponent implements OnInit {
  ...
  allTvShows: any[] = [
    ...
    {
      backdrop_path: '/2yxELZvTiILrLr1U3iZDfvTZFpI.jpg',
      ...
      original_name: 'Yeşil Vadinin Kızı',
      overview:
      ...
      popularity: 2356.124,
      poster_path: '/h9SChBQEogtVEJRHOxbHUtHahay.jpg',
      vote_average: 0,
      vote_count: 0,
    },
    {
    ...
    {
      backdrop_path: '/5rAkDWDtMqkZBAyNCeSiXkAoubJ.jpg',
    ...
    {
      backdrop_path: '/oVGvAvT17WmwST2vxIPdgS1UgT5.jpg',
